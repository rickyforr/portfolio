...
export default function Fotter(props: {
    ...
    text-sm  space-y-2  "
                >
                    <span className="group-hover:text-AAsecondary sm:text-xs text-xs max-w-[700px] text-center">
                        This website is based on the code from anaflous.com,
                        with modifications and customizations made by Richard Forrester. The original code for anaflous.com can be found
                        at https://github.com/hktitof/my-website. I would like to
                        acknowledge and express gratitude to the original
                        creator for providing the foundation for this website.{" "}
                    </span>
