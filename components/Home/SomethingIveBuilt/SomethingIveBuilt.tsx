                        ...
                        >
                            ...
                            <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                                <p className="text-gray-300 md:text-gray-400 text-left ">
                                    I led the Frontend development for
                                    omakasea.dev a generative nft art generator
           ...
           transition-opacity opacity-20 hover:opacity-0 hover:cursor-pointer duration-300"
            ...
            col-span-8 flex flex-col items-start md:items-end space-y-3"
                        >
                            ...
                            <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                                <p className="text-gray-300 md:text-gray-400 text-left">
                                    This project is an example of gamified
                                    blockchain patronage. A GOOEY is your own
                                    living, breathing, dynamic creature NFT that
                                    lives in a super cute Tamagotchi-style web 3
                                    application. GOOEYs need your love and
                                    support to thrive, divide into more GOOEYs
                                    and drop gifts along the way. Each GOOEY has
                                    it's own base traits, disposition, taxonomy
                                    and age. GOOEYs can also be equipped with
                                    new unique add-ons, claimable to those who
                                    keep their GOOEYs healthy and happy.
                                </p>
                            </div>
                            <ul
                                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
